# d2bbb_tiny_classifier_2_plots.py
...
## 1 ###########################################################
# # 5a. Plot NN decision regions only
# first version
# plt.figure(figsize=(6, 6))
# plt.contourf(xx, yy, Z, alpha=0.8)

# plt.title("D2 Tiny Classifier: NN Predicted Regions Only")
# plt.xlabel("x")
# plt.ylabel("y")
# plt.axis("equal")
# plt.show()
...
## 2 #####################################################
# 5a. Plot NN decision regions + test dots only
...
# # correctly predicted test points
# plt.scatter(
#     X_test[correct, 0],
#     X_test[correct, 1],
#     s=12,
...
# # incorrectly predicted test points
# plt.scatter(
#     X_test[~correct, 0],
#     X_test[~correct, 1],
#     s=30,
...
# plt.title("D2 Tiny Classifier: Test Points")
# plt.xlabel("x")
# plt.ylabel("y")
# plt.axis("equal")
# plt.legend()
